...
export default function ProfileDisplay({ userInfo, userProfileInfo, subjectsInfo, availabilityInfo, isTeacher}) {
    ...
    return (
        ...
        <div className="tile is-ancestor">
          <div className="tile is-parent is-vertical is-5">
            ...
            {isTeacher === false ? (
              <div className="tile is-child box">
                <p>Special Education: {userProfileInfo.special_ed === true ? "Yes" : "No"}</p>
              </div>
            ) : null}
